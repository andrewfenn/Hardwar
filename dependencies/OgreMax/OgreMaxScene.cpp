...
void OgreMaxScene::LoadScene(const TiXmlElement* objectElement)
{
    ...
    while (childElement != 0)
    {
        ...
        childElement = OgreMaxUtilities::IterateChildElements(objectElement, childElement);      
    }
...
void OgreMaxScene::LoadInstancedGeometry(const TiXmlElement* objectElement)
{
    ...
    //Add the entities
    childElement = OgreMaxUtilities::IterateChildElements(entitiesElement, 0);
    while (childElement != 0)
    {
        elementName = childElement->Value();
        ...
        childElement = OgreMaxUtilities::IterateChildElements(entitiesElement, childElement);
    }
...
void OgreMaxScene::LoadRenderTextures(const TiXmlElement* objectElement)
{
    ...
    const TiXmlElement* renderTextureElement = OgreMaxUtilities::IterateChildElements(objectElement, 0);
    while (renderTextureElement != 0)
    {
        ...
        String elementName;
        const TiXmlElement* childElement = OgreMaxUtilities::IterateChildElements(renderTextureElement, 0);
        while (childElement != 0)
        {
            elementName = childElement->Value();
            ...
            childElement = OgreMaxUtilities::IterateChildElements(renderTextureElement, childElement);
        }
        ...
        renderTextureElement = OgreMaxUtilities::IterateChildElements(objectElement, renderTextureElement);
    }
}
