 ...
 * Description: Load up our world.db file which contains building locations and
 * other data which is used to get a game going.
 */
 ...
 * Description: Loads all the building data in the SQL file 
 */
 ...
 * Description: Get rid of a building in our current state (not file)
 */
 ...
 * Description: Save the current state of our game to a database file
 */
 ...
 * Description: Add a new building to our current game state. Not saved until 
